...
DROP TABLE IF EXISTS `wp_learnpress_user_courses`;
...
LOCK TABLES `wp_learnpress_user_courses` WRITE;
/*!40000 ALTER TABLE `wp_learnpress_user_courses` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_learnpress_user_courses` ENABLE KEYS */;
UNLOCK TABLES;

...
DROP TABLE IF EXISTS `wp_learnpress_user_quizzes`;
...
LOCK TABLES `wp_learnpress_user_quizzes` WRITE;
/*!40000 ALTER TABLE `wp_learnpress_user_quizzes` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_learnpress_user_quizzes` ENABLE KEYS */;
UNLOCK TABLES;
